...
class Staff_model extends CI_Model {
   ...
   {
    $query=$this->db->select('staff.id as sid,staff.name,staff_leave_log.user_id,staff_leave_log.user_id,staff_leave_log.action,staff_leave_log.old_alloted_leave,staff_leave_log.new_alloted_leave,staff_leave_details.staff_id,staff_leave_details.id as slid,leave_types.id as lid,leave_types.type')->from('staff_leave_log')
    ->join('staff','staff.id =staff_leave_log.staff_id')->join('staff_leave_details','staff_leave_details.id=staff_leave_log.leave_id')
    ->join('leave_types','leave_types.id=staff_leave_log.leave_type_id')->get()->result_array();
