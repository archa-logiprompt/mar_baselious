                        ...
                        <div class="box box-info" id="attendencelist">
                            <div class="box-header with-border" >
                                <div class="row">
                                    ...
                                    <h6 >NP  :  No Period  , P  :  Present, A  :  Absent</h6>
...
$i=0;
                                                ...
                                                foreach($students as $index=> $student){
                                                    $present_count = array_count_values($student['attendancedata'])['1'];
                                                    $absent_count = array_count_values($student['attendancedata'])['0'];
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <th>
                                                        <?php echo $present_count?$present_count:0 ?>
                                                    </th>
                                                    <th>
                                                            <?php echo $absent_count?$absent_count:0 ?>
                                                           ...
                                                           foreach($student['attendancedata'] as $row){
                                                            ...
                                                            <td>                                                            
                                                            <?php if ($row == null) {
                                                                    echo '<span class="np-color" style="font-size:14px">NP</span>';
                                                                } else if ($row == 1) {
                                                                    echo '<span class="a-color" style="font-size:14px">A</span>';
                                                                } else if ($row == 0) {
                                                                    echo '<span class="p-color" style="font-size:14px">P</span>';
                                                                }?>
                                                            </td>
                                                         <?php } 
                                                         $i++;
