...
class LeaveTypes extends Admin_Controller
{
    ...
    function createLeaveType()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $leavemethod = implode(',', $this->input->post("method"));
            ...
            if (!empty($leavetypeid)) {
                $data = array('type' => $type, 'is_active' => 'yes', 'id' => $leavetypeid, 'method' => $leavemethod);
            } else {

                $data = array('type' => $type, 'is_active' => 'yes', 'method' => $leavemethod);
            }
