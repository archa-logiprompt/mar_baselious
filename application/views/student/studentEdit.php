...
<div class="content-wrapper">
 ...
 <input id="" name="measure_date" placeholder="" type="text" class="form-control date"  value="<?php echo date('d/m/y'); ?>" readonly="readonly"/>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="guardian_is"  checked value="father" > <?php echo $this->lang->line('father'); ?>
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="guardian_is"  value="mother"> <?php echo $this->lang->line('mother'); ?>
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="guardian_is"  value="other"> <?php echo $this->lang->line('other'); ?>
                                            </label>
