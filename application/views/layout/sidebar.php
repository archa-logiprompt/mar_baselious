                    ...
                    <!-- <li class="<?php //echo set_Submenu('worklog/index'); ?>"><a
                           href="<?php //echo base_url(); ?>admin/worklog"><i class="fa fa-angle-double-right"></i> Work
                            ...
                            <?php
                                          ...
                                          if ($this->rbac->hasPrivilege('weekly_calendar', 'can_create')) {
                                            ?>
                            ...
                            if (($this->rbac->hasPrivilege('staff', 'can_view') ||
                             $this->rbac->hasPrivilege('staff_attendance', 'can_view') ||
                              $this->rbac->hasPrivilege('staff_attendance_report', 'can_view') ||
                               ...
                               $this->rbac->hasPrivilege('leave_report', 'can_view') ||
                ...
                <ul class="treeview-menu">
                    ...
                    <?php
                                        ...
                                        if ($this->rbac->hasPrivilege('leave_report', 'can_view')) {
                                            ?>
                    <li class="<?php echo set_Submenu('admin/staff/leave_report'); ?>"><a
                            href="<?php echo base_url(); ?>admin/staff/leave_report"><i
                                class="fa fa-angle-double-right"></i>
                            <?php echo $this->lang->line('leave_report'); ?> <?php echo 'Leave Report'; ?></a></li>
                    <?php
                                        }
                 ...
                 <?php
                                        ...
                                        if ($this->rbac->hasPrivilege('add_staff_leave', 'can_view')) {
                                            ?>
                    <li class="<?php echo set_Submenu('admin/staff/staff_leave'); ?>"><a
                            href="<?php echo base_url(); ?>admin/staff/staff_leave"><i
                                class="fa fa-angle-double-right"></i> <?php echo 'Add staff leave'; ?></a></li> 
                 <?php
                                        }
